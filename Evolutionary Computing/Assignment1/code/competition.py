...
experiment_name = 'test_run_plus_enemy2'
n_enemies = 8
n_hidden = 10
...
# past the best solutions of the runs for enemy X in de solutions folder
enemies = [2]
index = 0
...
if mode == "test":
    ...
    plt.savefig("gain_hist_whole_group_MplusL"+"_enemy="+str(enemy) + ".png", dpi=300)
    df_final.to_csv('Boxplot_csv/{exp}.csv'.format(exp=experiment_name))
