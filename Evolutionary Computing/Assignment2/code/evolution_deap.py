...
experiment_names = ['dummy_demo_mu_plus_lambda_enemy=2_5', 'dummy_demo_mu_plus_lambda_enemy=6_8']
different_enemies = [[2, 5], [6, 8]]
for experiment_name, enemy in zip(experiment_names, different_enemies):
    ...
    def experiment(function, runs, MU, LAMBDA, CXPB, MUTPB, NGEN, enemies):
        ...
        for i in range(runs):
            ...
            # solutions = [pop, toolbox.evaluate(pop)]
